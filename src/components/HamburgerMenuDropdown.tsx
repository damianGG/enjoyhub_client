    ...
    return (
        <div className="relative flex items-center justify-center p-2 border-2 rounded-full w-11 h-11">
            <Popover className={`relative flex `}>
                <>
                    <Popover.Button
                        className={`self-center w-10 h-10 sm:w-12 sm:h-12 rounded-full text-slate-700    focus:outline-none flex items-center justify-center`}
                    >
                            ...
                            <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5">
                                <div className="relative grid grid-cols-1 gap-6 bg-white  py-7 px-6">
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            <p className="text-sm font-medium ">{"Zaloguj"}</p>
                                        </div>
                                    </Link>)}
                                    <Link
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            <p className="text-sm font-medium ">{"Ulubione"}</p>
                                        </div>
                                    </Link>
                                    <div className="w-full border-b border-neutral-200 " />
                                    <Link href="/about-us">
                                        <div className="flex items-center justify-between p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-neutral-100  focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    <p className="text-sm font-medium ">{"O nas"}</p>
                                                </div>
                                            </div>
