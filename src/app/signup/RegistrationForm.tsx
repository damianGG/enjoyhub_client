            ...
            {isRegistered ? (
                ...
                <form className="grid grid-cols-1 gap-6" onSubmit={handleSubmit(onSubmit)}>
                    <label className="block">
                        ...
                        <input className="block w-full border-neutral-200 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white     rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1" {...register("name", { required: true })} placeholder="Imie" />
                    </label>
                    <label className="block">
                        <span className="flex justify-between items-center ">
                            Adres email
                        </span>
                        <input className="block w-full border-neutral-200 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white  rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1" {...register("email", { required: true })} onBlur={(e) => checkEmailExists(e.target.value)} placeholder="Email" />
                    ...
                    <label className="block">
                        ...
                        <input className="block w-full border-neutral-200 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white     rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1" {...register("password", { required: true })} type="password" placeholder="Hasło" />
                        {errors.email && <span>To pole jest wymagane</span>}
                    </label>
