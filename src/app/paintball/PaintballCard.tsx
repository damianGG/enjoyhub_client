            ...
            <div className="pl-5 pr-5 pb-5 space-y-4 mb-3 mt-3">
                <div className="space-y-2">
                    ...
                    <div className="flex items-center text-neutral-500  text-sm space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" className="w-4 h-4"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z"></path></svg>
                        <span>{data?.city}</span>
                ...
                <div className="flex justify-between items-center mb-2">
                    <span className="text-base font-semibold">130 zł<span className="text-sm text-neutral-500 dark:text-neutral-400 font-normal">/osoba</span>
                        ...
                        <span className="text-neutral-500 dark:text-neutral-400">(478)</span>
                    </div>
                </div>
