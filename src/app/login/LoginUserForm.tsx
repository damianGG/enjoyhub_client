        ...
        <>
            ...
            <form className="grid grid-cols-1 gap-6" >
                <label className="block">
                    ...
                    <input className="block w-full border-neutral-200 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white     rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1" {...register("email", { required: true })} placeholder="Email" />
